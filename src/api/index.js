...
export const searchList = ()=>myAxios.get('/5000/xhr/search/init.json')
export const searchData = (kwd)=>myAxios.get(`/5000/xhr/search/searchAutoComplete.json?keywordPrefix=${kwd}`)